 ...
 * 
 * ⚠️ Un versamento copre **rate intere** (`RB36`): una rata è già l'unità in cui
 * il pagamento è stato spezzato, e non si rateizza una rata. Chi ne ha
 * concordate tre da 60 € versa 60, 120 o 180. Il controllo è in
 * `BalanceSettlementService.assertLandsOnInstalment`, e vale prima che il
 * denaro passi di mano — mai sulla coda offline, dove il contante è già preso.
 * 
